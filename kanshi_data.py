...
kubo = [[10, 11], [8, 9], [6, 7], [4, 5], [2, 3], [0, 1]]
...
twelve_fortune = ["長生", "沐浴", "冠帯", "建禄", "帝旺", "衰", "病", "死", "墓", "絶", "胎", "養"]
...
getsurei = ["月令を得て旺ず", "月令を得て相す", "月令を得ず休す", "月令を得ず囚す", "月令を得ず死す"]

getsurei_table = [
    [
        ["寅（2月・春）", "卯（3月・春）", "辰（4月・春土用）"],
        ["亥（11月・冬）", "子（12月・冬）", "丑（1月・冬土用）"],
        ["巳（5月・夏）", "午（6月・夏）", "未（7月・夏土用）"],
        ["戌（10月・秋土用）"],
        ["申（8月・秋）", "酉（9月・秋）"],
    ],  # 甲
    [
    ...
    [
        ["丑（1月・冬土用）", "辰（4月・春土用）", "未（7月・夏土用）", "戌（10月・秋土用）"],
        ["巳（5月・夏）", "午（6月・夏）"],
        ["申（8月・秋）", "酉（9月・秋）"],
        ["亥（11月・冬）", "子（12月・冬）"],
        ["寅（2月・春）", "卯（3月・春）"],
    ...
    [
        ["申（8月・秋）", "酉（9月・秋）", "戌（10月・秋土用）"],
        ["丑（1月・冬土用）", "辰（4月・春土用）", "未（7月・夏土用）"],
        ["亥（11月・冬）", "子（12月・冬）"],
        ["寅（2月・春）", "卯（3月・春）"],
        ["巳（5月・夏）", "午（6月・夏）"],
    ],  # 庚
...
sango = [[[11, 3, 7], 0, 1], [[2, 6, 10], 1, 2], [[5, 9, 1], 3, 7], [[8, 0, 4], 4, 8]]
...
hogo = [[[11, 0, 1], 4], [[2, 3, 4], 0], [[5, 6, 7], 1], [[8, 9, 10], 3]]
