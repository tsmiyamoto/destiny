    ...
    def show_basic_info(self):
        ...
        if self.t_flag:
            print(
                ...
                + wareki
                + "）"
                + str(self.birthday.month)
                + "月"
                + str(self.birthday.day)
                + "日 "
                + str(self.birthday.hour)
                + "時"
                + str(self.birthday.minute)
                + "分生 "
                + sex_str
            )
        else:
    ...
    def show_additional_info(self, flag):
        ...
        if flag:
            ...
            if not self.meishiki["hogo"]:
                ...
                print(
                    kd.shi[self.meishiki["hogo"][0][0]]
                    + ", "
                    + kd.shi[self.meishiki["hogo"][0][1]]
                    + ", "
                    + kd.shi[self.meishiki["hogo"][0][2]]
                    + "で"
                    + kd.gogyo[self.meishiki["hogo"][1]]
                    + "方合"
                )
